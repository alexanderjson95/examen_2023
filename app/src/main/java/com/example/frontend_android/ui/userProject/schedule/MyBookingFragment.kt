...
//                        val availableDays =
//                            bookedMap.filter { it.value.any { booking -> booking.status == BookingStatusType.AVAILABLE } }
//                                .keys
//                                .toList()
//                        val bookedDays =
...
//                            availability = true
//                            memberSpinner.visibility = View.INVISIBLE
//                            selectedUser = bookingVM.user.value?.firstName ?: "";
...
//                when(dayOfWeek){
//                    DayOfWeek.SUNDAY -> ":D"
//                    else -> dayOfWeek.getDisplayName(TextStyle.SHORT, Locale("sv"))
//                }
//            }
//            bookingVM.getAccepted(projectId)
...
//                                id: Long
//                            ) {
//                                selectedUser = membersList[position].firstName.toString()
...
//                    val acception = bookingsForDay?.map { it.status == BookingStatusType.ACCEPTED }
