package com.example.frontend_android.ui.userProject.members
    ...
    ListAdapter<UserRoleResponse, InviteUserAdapter.InviteUserViewHolder>(DiffCallback())
{
    ...
    class InviteUserViewHolder(view: View) : RecyclerView.ViewHolder(view){
        var fName_value: TextView = view.findViewById(R.id.name_value)
    ...
    override fun onCreateViewHolder(
        ...
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_projectuser_request, parent, false)
    ...
    override fun onBindViewHolder(
        ...
        holder.removeBtn.setOnClickListener {
            removeUser(users.userId)  // lägger in userId ur userProject
            holder.removeBtn.isEnabled = false // överdriven extra säkerhet
            holder.removeBtn.text = "Borttagen"
        }
